...
asm3model Python package (2026). Taher Abunama.
...
Please preserve the upstream notice and attribution text in ``LICENSE`` and ``THIRD_PARTY_NOTICES.md`` when redistributing package metadata.
